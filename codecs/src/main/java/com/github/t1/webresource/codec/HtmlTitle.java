...
public @interface HtmlTitle {
    /**
     * Used for mappings; defaults to {@link com.github.t1.webresource.tools.StringTool#camelToWords()} to the pojo's simple class name.
    ...
    /**
     * Used for collections; defaults to applying {@link com.github.t1.webresource.tools.StringTool#pluralize(String)}
     * to the {@link #value()}.
     */
